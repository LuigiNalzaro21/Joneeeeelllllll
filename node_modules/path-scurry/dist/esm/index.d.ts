...
export declare abstract class PathBase implements Dirent {
 ...
 0,E.w_)(this.livestreamGlobal.url))}setupTelemetryObjects(){if(null==this.telemetryObject)return;const e=this.parentTelemetry&&this.parentTelemetry.contract&&this.parentTelemetry.contract.ext;this.esportsStreamTelemetryObject=this.telemetryObject.addOrUpdateChild({name:g,action:w.Aw.View,type:w.c9.Module,behavior:w.wu.View,content:{id:g,type:w.uH.StructuredData,vertical:v,category:x,headline:f},ext:e}),this.wholeCardTelemetryTag=this.esportsStreamTelemetryObject.getMetadataTag(),this.seeMoreTelemetryTag=this.esportsStreamTelemetryObject.addOrUpdateChild({name:m,action:w.Aw.Click,type:w.c9.Module,behavior:w.wu.Navigate,content:{id:m,type:w.uH.StructuredData,vertical:v,category:x,headline:f},ext:e}).getMetadataTag(),this.actionsMenuTelemetryTag=this.esportsStreamTelemetryObject.addOrUpdateChild({name:u,action:w.Aw.Click,type:w.c9.ActionButton,behavior:w.wu.More,content:{id:u,type:w.uH.StructuredData,vertical:v,category:x,headline:f},ext:e}).getMetadataTag()}shadowDomPopulated(){try{this.cardActionRef=this.shadowRoot.querySelector("esports-lv-title")}catch(e){y.M0.sendAppErrorEvent(Object.assign(Object.assign({},d.ReU),{message:"not able to load esports livestream ntp card",pb:Object.assign(Object.assign({},d.ReU.pb),{customMessage:"not able to load esports livestream ntp card"})}))}}getExperienceType(){return G.x.esportsStreamsCard}toggleActionMenu(e,t){this.isActionMenuOpen=e,this.isActionMenuOpen?(this.actionsMenuButtonElement=t&&t.currentTarget,document.addEventListener("click",this.onOutsideClick),document.addEventListener("keydown",this.onKeydown)):(this.actionsMenuButtonElement=null,document.removeEventListener("click",this.onOutsideClick),document.removeEventListener("keydown",this.onKeydown)),t&&t.currentTarget&&y.M0.sendActionEvent(t.currentTarget,w.Aw.View,w.wu.View)}getActionMenuItems(){return[{id:"hideCard",glyph:this.iconHide,title:this.config&&this.config.localizedStrings&&this.config.localizedStrings.hideCard,telemetryTag:this.esportsStreamTelemetryObject&&this.esportsStreamTelemetryObject.addOrUpdateChild({name:h,action:w.Aw.Click,type:w.c9.ActionButton,behavior:w.wu.Hide,content:{id:h,type:w.uH.StructuredData,vertical:v,category:x,headline:f}}).getMetadataTag(),onClick:()=>(0,l.mG)(this,void 0,void 0,(function*(){this.hideCardCallback()}))},{id:"moreSettings",glyph:this.iconSettings,title:this.config&&this.config.localizedStrings&&this.config.localizedStrings.moreSettings,telemetryTag:this.esportsStreamTelemetryObject&&this.esportsStreamTelemetryObject.addOrUpdateChild({name:b,action:w.Aw.Click,type:w.c9.ActionButton,behavior:w.wu.Navigate,content:{id:b,type:w.uH.StructuredData,vertical:v,category:x,headline:f}}).getMetadataTag(),onClick:()=>(0,l.mG)(this,void 0,void 0,(function*(){this.goToPersonalizeSettingsCallback&&this.goToPersonalizeSettingsCallback()}))}]}getThumbnailUrl(e){return e?"https://www.bing.com/th?id="+e+"&w=407&h=229&dpr=1.5&c=11&rs=1&qlt=100&rf=hubstream_fallback.jpg&pid=LS&bc=1c1c29&p=0":null}}(0,l.gn)([(0,k.Lj)({attribute:"card-layout"})],U.prototype,"cardLayout",void 0),(0,l.gn)([T.LO],U.prototype,"isActionMenuOpen",void 0),(0,l.gn)([T.LO],U.prototype,"actionMenuItems",void 0),(0,l.gn)([T.LO],U.prototype,"livestreamGlobal",void 0);var z=i(93703);i(79668).S;const N=L.dy`<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6 10a1.25 1.25 0 11-2.5 0A1.25 1.25 0 016 10z" /><path d="M11.25 10a1.25 1.25 0 11-2.5 0 1.25 1.25 0 012.5 0z" /><path d="M15.25 11.25a1.25 1.25 0 100-2.5 1.25 1.25 0 000 2.5z" /></svg>`,F=L.dy`<msn-actions-menu :referrerButton=${e=>e.actionsMenuButtonElement} :menuItems=${e=>e.actionMenuItems} />`,R=L.dy` ${""} ${(0,z.g)((e=>e.cardLayout===p.Xg.EsportsCardLayout._1x_2y),L.dy`<div class="root" data-t="${e=>e.wholeCardTelemetryTag}"><div class = "div-esports-toplevel1" id = "div-esports-toplevel1"><div id="esports-lv-cont1" class="esports-lv-cont1"><div id="esp-streams-settings-div" class="esp-streams-settings-div"><fluent-button appearance="neutral" class="more-options" part="more-options" @click=${(e,t)=>e.toggleActionMenu&&e.tjects directly.  They should always be accessed
     * via the PathScurry class or other methods on the Path class.
     *
     * @internal
     */
...
export interface WalkOptions {
     ...
     * true, symbolic links to directoringButtonDescription": "Remove Tracking for $1",
  ...
  "settingsMicrofeedbackDislikeOptionPasswords": "I do not like the extra step to access passwords",
  "settingsMicrofeedbackDislikeOptionPayments": "I do not like the extra step to access payments methods",
  "settingsMicrofeedbackDislikeOptionPersonalInfo": "I do not like the extra step to access personal information",
  "settingsMigrationBannerAction": "Enable",
  "settingsMigrationBannerTitle": "Make Wallet your default personal assets management experience in Edge?",
  "settingsMoreSettingsButtonText": "More settings",
  "settingsPasswordsAutoSavePasswords": "Automatically save passwords",
  "settingsPasswordsAutofillPasswords": "Autofill passwords",
  "settingsPasswordsAutofillPasswordsAutofillOption": "Fill website password and sign in automatically",
  ...
  "settingsPasswordsAutofillPasswordsDescription": "Allow Microsoft Edge to automatically fill passwords.",
  ...
  "settingsPasswordsEnableSavePasswordsDescription": "Allow Microsoft Edge to save your pa